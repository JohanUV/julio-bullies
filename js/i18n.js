...
window.I18N = {
  es: {
    ...
    "vid.pill": "Videos", "vid.title": "Míralo <em>caminar</em>", "vid.p": "Las fotos muestran el tipo; el movimiento muestra la estructura. Toca el altavoz para escuchar la música, o el video para verlo en grande.", "vid.open": "Ver con sonido", "vid.sound": "Escuchar", "vid.mute": "Silenciar", "vid.c1": "Caminando", "vid.c2": "Estructura en movimiento",
  ...
  en: {
    ...
    "vid.pill": "Videos", "vid.title": "Watch him <em>move</em>", "vid.p": "Photos show type; movement shows structure. Tap the speaker to hear the music, or the video to watch it full size.", "vid.open": "Watch with sound", "vid.sound": "Listen", "vid.mute": "Mute", "vid.c1": "On the walk", "vid.c2": "Structure in motion",
  ...
  pt: {
    ...
    "vid.pill": "Vídeos", "vid.title": "Veja ele <em>andar</em>", "vid.p": "As fotos mostram o tipo; o movimento mostra a estrutura. Toque no alto-falante para ouvir a música, ou no vídeo para vê-lo em tela grande.", "vid.open": "Ver com som", "vid.sound": "Ouvir", "vid.mute": "Silenciar", "vid.c1": "No passeio", "vid.c2": "Estrutura em movimento",
