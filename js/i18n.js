...
window.I18N = {
  es: {
    ...
    "vid.pill": "Videos", "vid.title": "Míralo <em>caminar</em>", "vid.p": "Las fotos muestran el tipo; el movimiento muestra la estructura. Toca un video para verlo en grande con música.", "vid.open": "Ver con sonido", "vid.open1": "Ver con música", "vid.c1": "Caminando", "vid.c2": "Estructura en movimiento",
  ...
  en: {
    ...
    "vid.pill": "Videos", "vid.title": "Watch him <em>move</em>", "vid.p": "Photos show type; movement shows structure. Tap a video to watch it full size with music.", "vid.open": "Watch with sound", "vid.open1": "Watch with music", "vid.c1": "On the walk", "vid.c2": "Structure in motion",
  ...
  pt: {
    ...
    "vid.pill": "Vídeos", "vid.title": "Veja ele <em>andar</em>", "vid.p": "As fotos mostram o tipo; o movimento mostra a estrutura. Toque em um vídeo para vê-lo em tela grande com música.", "vid.open": "Ver com som", "vid.open1": "Ver com música", "vid.c1": "No passeio", "vid.c2": "Estrutura em movimento",
